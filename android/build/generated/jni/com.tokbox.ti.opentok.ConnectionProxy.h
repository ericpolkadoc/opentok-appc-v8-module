...
private:
	...
	static void getConnectionId(const v8::FunctionCallbackInfo<v8::Value>&);

	// Dynamic property accessors ----------------------------------------
	static void getter_creationTime(v8::Local<v8::Name> name, const v8::PropertyCallbackInfo<v8::Value>& info);
	static void getter_connectionId(v8::Local<v8::Name> name, const v8::PropertyCallbackInfo<v8::Value>& info);
